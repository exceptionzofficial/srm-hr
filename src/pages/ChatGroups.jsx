...
const ChatGroups = () => {
    ...
    const userId = storedUser.employeeId || storedUser.managerId || storedUser.id || 'hr-admin-1';

    const currentUser = {
        id: userId,
        name: storedUser.name || 'HR Manager'
    };
                        ...
                        <form onSubmit={handleCreateGroup}>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder="e.g. 2 Days, or Dec 31st"
                                />
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                >
                                    <option value="standard">Standard (Everyone chats)</option>
                                    <option value="announcement">Announcement (Admins only, Employees vote)</option>
                                </select>
                            </div>
